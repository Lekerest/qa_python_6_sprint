...
class LocatorsOrderDelivery:
    ...
    BUTTON_STATION_BULVAR_ROCOSOVSKOGO = (By.XPATH, ".//button[(@class='Order_SelectOption__82bhS select-search__option') and (@value='1')]")
    ...
    CHECKBOX_COLOR_SCOOTER_BLACK = (By.XPATH, ".//label[@class='Checkbox_Label__3wxSf']")
    ...
    #Кнопка заказать
    BUTTON_ORDER_CREATED = (By.XPATH, ".//button[(@class='Button_Button__ra12g Button_Middle__1CSJM') and (text()='Заказать')]")

    #Текст Заказ оформлен
    TEXT_ORDER_CREATED = (By.XPATH, ".//div[(@class='Order_ModalHeader__3FDaJ') and (text()='Заказ оформлен')]")

    #Тело страницы
    BODY_PAGE = (By.XPATH, "//body")
