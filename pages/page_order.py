...
class PageOrder(BasePage):
    ...
    def input_field_telephone_number(self, field_telephone):
        return self.driver.find_element(*LocatorsOrderDelivery.FIELD_ADDRESS).send_keys(field_telephone)
    ...
    def input_date_delivery(self, date_delivery):
        ...
        return self.driver.find_element(*date_delivery).click()
    ...
    def select_colour(self, comment):
